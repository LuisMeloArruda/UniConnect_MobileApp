...
import 'tags3_model.dart';
export 'tags3_model.dart';

class Tags3Widget extends StatefulWidget {
  const Tags3Widget({super.key});

  @override
  State<Tags3Widget> createState() => _Tags3WidgetState();
}

class _Tags3WidgetState extends State<Tags3Widget> {
  late Tags3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Tags3Model());
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'yesnxnps' /* Not seeing a language?
Add it ... */
                          ,
                        ),
