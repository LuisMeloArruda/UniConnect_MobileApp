                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              key: const ValueKey('IconButton_w2f6'),
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: FlutterFlowIconButton(
                                            key: const ValueKey('IconButton_lk1x'),
                                            borderColor:
                      ...
                      Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => TextFormField(
                            key: const ValueKey('username_edit_psht'),
                            ...
                            validator: _model
                                .usernameEditTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => TextFormField(
                            key: const ValueKey('RealName_edit_x3pz'),
                            ...
                            validator: _model
                                .realNameEditTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            50.0, 0.0, 50.0, 16.0),
                        child: TextFormField(
                          key: const ValueKey('email_edit_0thr'),
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 115.0, 55.0, 0.0),
                              child: FlutterFlowIconButton(
                                key: const ValueKey('IconButton_ogs4'),
                                borderColor:
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            key: const ValueKey('Button_ja9j'),
                            onPressed: () async {
                              if (FFAppState().ChangePhoto == false) {
                                await columnUsersRecord.reference
                                  ...
                                  realName:
                                      _model.realNameEditTextController.text,
                                ));
                              } else {
                                {
                                  setState(
