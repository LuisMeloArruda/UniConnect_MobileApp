...
import '/chat/pages/chat/chat_thread/chat_thread_widget.dart';
import '/chat/pages/chat/empty_state_simple/empty_state_simple_widget.dart';
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadWidget(
                          key: Key(
                            'Key1et_${listViewChatMessagesRecord.reference.id}',
                          ),
                            ...
                            children: [
                              Padding(
                                ...
                                child: SizedBox(
                                  width: double.infinity,
                                  child: TextFormField(
                                    key: const ValueKey('TextField_daef'),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 6.0, 4.0),
                                  child: FlutterFlowIconButton(
                                    key: const ValueKey('IconButton_dec6'),
                              ...
                              Align(
                                alignment: const AlignmentDirectional(0.77, -0.5),
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 10.0, 0.0),
                                  child: FlutterFlowIconButton(
