  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ChatsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatsRecord> homePageChatsRecordList = snapshot.data!;
            ...
            child: Scaffold(
              ...
              endDrawer: SizedBox(
                ...
                child: Drawer(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 109.0),
                    child: Column(
                ...
                child: Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: MediaQuery.sizeOf(context).width * 0.618,
                        height: 69.0,
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Column(
                                            key: const ValueKey('Column_ex3c'),
                                            mainAxisSize: MainAxisSize.max,
                                            mainAxisAlignment:
...
Students */
                                    ...
                                    Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Column(
                                          key: const ValueKey('Column_4nmt'),
                                          mainAxisSize: MainAxisSize.max,
                                          children: [
                                            Align(
                                              alignment: const AlignmentDirectional(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      key: const ValueKey('Column_idml'),
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        Align(
                                          alignment:
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      key: const ValueKey('Column_bq4m'),
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        Align(
                                          alignment:
